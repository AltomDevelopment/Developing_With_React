...
- [npm run start in terminal then live server for project build](#npm-run-start-in-terminal-then-live-server-for-project-build)
...
# npm run start in terminal then live server for project build
## Quick start
